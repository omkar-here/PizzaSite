        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            ...
            <p className="py-6 font-semibold text-xl">
              Indulge in a slice of heaven with our artisanal pizzas, crafted
              with love and the finest ingredients. From classic Margherita to
              bold and flavorful creations, our pizzeria is your gateway to an
